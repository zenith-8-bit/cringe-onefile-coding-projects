...
PAUSE_AMOUNT = 0.00000001  # Pause length of one-tenth of a second.
WIDTH, HEIGHT = 80, 24
SCALEX = (WIDTH - 4) // 8
SCALEY = (HEIGHT - 4) // 8
...
# RANDOM BULLSHIT TEXT HERE - This cube spins in dimensions you can't even comprehend, 
# floating through digital realms of infinite possibilities, encoding the mysteries of the universe
